    ...
    <div className="main flex-1 px-5  pb-5   min-h-screen">
      ...
      <div className="flex items-center justify-center">
        <div className="main-bottom   w-[80%] mb-5 right-4 px-4">
          <div className="search-box flex py-3 px-4 border-2 rounded-lg  ">
            <input
        ...
        {!showResult ? (
          <>
            <div className="greet my-[50px] p-5 ">
              <p className="py-1 text-center text-orange-700 capitalize italic">Welcome to Cols-nutraceutical humanoid Assistant!</p>
              <p className=" text-center capitalize">How can i help you?.</p>
            </div>
